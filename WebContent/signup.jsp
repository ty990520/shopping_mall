...
<div class="maintablestyle_signup">
      ...
      <form id="form1" name="form6" method="post" action="signuppro.jsp" onSubmit="return validateAll(this)">
      <table width="468" border="0" cellpadding="0" cellspacing="0" id="registerform_signup">
        <tr>
            <th width="200">이름</th>
            <td width="400">
               <div><input type="text" id="name" name="name" class="field" maxlength="20" onkeyup="validateName()"/></div>
          ...
          <tr>
            <th>아이디</th>
            <td width="337">
              <div><input type="text" id="memberId" name="memberId" class="field" maxlength="20" onkeyup="validateId()"/></div>
           <div id="id_alert" class="alert"/>
            </td>
          </tr>
          <tr>
            <th>비밀번호</th>
            <td>
               <div><input type="password" id="password" name="password" class="field" maxlength="20" onkeyup="validatePassword()"/></div>
           ...
           <tr>
            <th>비밀번호확인</th>
            <td>
               <div><input type="password" id="passwordCheck" name="passwordCheck" class="field" maxlength="20" onkeyup="validatePassword()"/></div>
          ...
          <tr>
            ...
            <td>
              ...
              -
              <input type="text" name="phone_middle" id="phone_middle" class="subfield" width="100px" maxlength="4" onkeyup="validatePhone()"/>
              -
           <input type="text" name="phone_last" id="phone_last" class="subfield" width="100px" maxlength="4" onkeyup="validatePhone()"/>
          ...
          <tr><td></td><td height=85><input type="submit" class="button_style2" value="가입" style="margin-right:100px"/></td><td></td></tr>
        </table>
       </form>    
      </div>
</div>
...
function validateAll() {
   ...
   if (name.length == 0 || memberId.length == 0 || memberId.length < 5 || !/^[A-Za-z0-9]*$/.test(memberId)
         || password.length == 0 || password.length < 5 || !/^[A-Za-z0-9]*$/.test(password)
         || passwordCheck.length == 0 || passwordCheck.length < 5 || !/^[A-Za-z0-9]*$/.test(passwordCheck)
         || password != passwordCheck || phone_middle.length == 0 || phone_last.length == 0
         || !/^[0-9]*$/.test(phone_middle) || !/^[0-9]*$/.test(phone_last)
         || phone_middle.length < 3 || phone_last.length < 4) {
